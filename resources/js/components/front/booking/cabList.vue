<template>
    <div class="text-gray-800">
        ...
        <div class="px-40 py-10 text-lg text-center" v-if="cars.length = 0" >
            <img src="" alt="" srcset="">
            <br>
        ...
        <div class=" text-lg text-center flex mt-16">
            ...
            <div class="w-full sm:w-9/12">
                ...
                <div class="flex justify-between mt-4">
                    <div class="w-3/12 flex">
                        <span class="font-bold ml-1">4 Buses </span>
                        <span> Found </span>
                    </div>
                ...
                <div class="border border-blue-500 shadow-sm p-4 my-10">
                    <div class="flex">
                        <div class="w-3/12">
                            <h4>BR Travels</h4>
                            <p>A/C Seater</p>
