    ...
    <aside class="w-full md:w-64 bg-gray-800 md:min-h-screen">
        <div class="flex items-center justify-between bg-gray-900 p-4 h-16">
            <a href="#" class="flex items-center">
                ...
                <span class="text-gray-300 text-xl font-semibold mx-2">OrnaSol</span>
            </a>
            ...
            <ul>
                ...
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <a href="#" class="flex items-center">
                        ...
                        <span class="mx-2 text-gray-300">Booking</span>
                    </a>
                </li>
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                ...
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <a href="#" class="flex items-center">
                        ...
                        <span class="mx-2 text-gray-300">Payment</span>
                    </a>
                </li>
                <!-- <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <a href="#" class="flex items-center">
                        ...
                        <span class="mx-2 text-gray-300">Logout</span>
                    </a>
                </li> -->
                <!-- <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <a href="#" class="flex items-center">
