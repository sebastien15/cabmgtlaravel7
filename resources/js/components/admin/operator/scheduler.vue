    ...
    <div>    
        ...
        <div 
            ...
            <div class="border-b-blue-200 mb-10">
                ...
                <p class="cursor-pointer" @click="()=>{this.showsingleSchedulerModel = !this.showsingleSchedulerModel; this.singleScheduler = {}}"><i class="fa fa-times text-blue-700 text-3xl"></i></p>
                </div>
